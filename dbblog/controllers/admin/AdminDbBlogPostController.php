...
class AdminDbBlogPostController extends ModuleAdminController
{
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'label' => $this->l('¿Cuándo quieres que se publique?'),
    ...
    public function processAdd()
    {
        ...
        if ($object->id > 0) {
            ...
            if(Tools::getValue('date_to_publish')){
                $object->date_to_publish = Tools::getValue('date_to_publish');
                $object->update();
            }
        }
    ...
    public function processUpdate()
    {
        ...
        if ($object != false && $object->id_dbblog_post > 0) {
            ...
            if (Tools::getValue('date_to_publish')) {
                $date_publish = Tools::getValue('date_to_publish');
                $object->date_publish = $date_publish;
                $object->update();
            }
